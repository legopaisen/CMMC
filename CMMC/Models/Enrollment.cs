...
namespace CMMC.Models
{
    public class Enrollment : IDisposable
    {
        ...
        public struct CmsCodeDetails
        {
            ...
            public List<Models.BANCS_ACCOUNT.Details> BancsAccounts { get; set; }
            public List<Models.ChildAccountsODS.Details> ChildAccountListODS{ get; set; }
        }
        ...
        public CmsCodeDetails GetEnrollmentDetails(int pCMSCode)
        {
            ...
            details.BancsAccounts= new Models.BANCS_ACCOUNT().GetList(pCMSCode);
            details.ChildAccountListODS = new Models.ChildAccountsODS().GetList(pCMSCode);
            return details;
        }
